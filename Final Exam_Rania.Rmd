...
To interpret the regression, I will first find the most common store type so I can compare other types to it.
```{r}
Main_st_data %>%
  group_by(type) %>%
  summarise(number = n()) %>%
...
I will now do a bivariate regression to see which store types have changes in parking costs comparing to the changes of parking cost in clothing stores.
...
Parking costs at restaurants increased by about (4) percentage points (more) than at clothing stores. Meaning that parking costs for restaurants increased by 15%.
Parking costs at furniture stores increased by about (7) percentage points (more) than at clothing stores. Meaning that parking costs for furniture stores increased by 18%.
